...
window.onload = function popup() {
  setTimeout(function() {
    createWindowSexyMessageService(12);
  }, 2500);
};
...
function createWindow(e) {
  ...
  var popupSize = 400;
  var popupHeight = 400;
  var top = 20 + Math.floor(Math.random() * 500);

  if(viewportWidth < 500){
    popupSize = 320;
    top = 700 + Math.floor(Math.random() * 50);
  }
  if(viewportWidth < 760){
    top = 500 + Math.floor(Math.random() * 50);
  }
  if(e == 11){ // Mailbox popup should be on top
    top = 20;
  }
  ...
  n.id = "closeButton" + e, n.innerHTML = " <img src='SVG/X.svg'/>  ", document.getElementById("window" + e + "header").insertBefore(n, document.getElementById("window" + e + "header").firstChild), document.getElementById("closeButton" + e).onclick = function() {
    ...
    i = document.getElementById("button" + e),
      ...
      "initial" === t.style.display ? activeWindow(t) : (t.style = "position: absolute;",
        randomTop = top,
        randomLeft = 10 + Math.floor(Math.random() * (viewportWidth - popupSize - 10)),
        t.style = "top: " + randomTop + "px; left:" + randomLeft + "px;", fadeIn(t))
  }, dragElement(t)
};
...
function getClientWidth() {
  var elmnt = document.getElementById("body_rel");
...
var closeBtn1 = document.getElementById('closeButton2'); //tigern is window 2

function reloadTrack1(){
  track1.load();
}
...
closeBtn1.addEventListener("click",reloadTrack1);

// TRACK 2
var track2 = document.getElementById('track2');
var controlBtn2 = document.getElementById('play-pause2');
var closeBtn2 = document.getElementById('closeButton3'); //flytefoam is window 3


function reloadTrack2(){
  track2.load();
}
...
closeBtn2.addEventListener("click",reloadTrack2);

// TRACK 3
var track3 = document.getElementById('track3');
var controlBtn3 = document.getElementById('play-pause3');
var closeBtn3 = document.getElementById('closeButton5'); //transit is window 5
function reloadTrack3(){
  track3.load();
}
...
function playPause3() {
  if (track3.paused) {
    track3.play();
    //controlBtn.textContent = "Pause";
    controlBtn3.className = "pause";
  } else {
    track3.pause();
    //controlBtn.textContent = "Play";
    controlBtn3.className = "play";
  }
};
...
closeBtn3.addEventListener("click",reloadTrack3);
